...
Namespace E1984
    Public Module MyTreeListSerializeHelper
        ...
        Private Sub SaveConditions(ByVal treeList As TreeList, ByVal fileName As String)
            ...
            Using stream As FileStream = New FileStream(fileName, FileMode.OpenOrCreate)

                Try
                    Dim collection As TreeListFormatConditions = New TreeListFormatConditions(treeList.FormatConditions)
        ...
        Private Sub RestoreConditions(ByVal treeList As TreeList, ByVal fileName As String)
            ...
            Using stream As FileStream = New FileStream(fileName, FileMode.Open)
                ...
                Try
                    Dim collection As TreeListFormatConditions = New TreeListFormatConditions()
